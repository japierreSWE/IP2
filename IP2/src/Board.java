...
public class Board {
	...
	public Board() {
		...
		GreyPiece gp1 = new GreyPiece(1, 1, 0, 0);
		GreyPiece gp2 = new GreyPiece(1, 2, 0, 1);
		GreyPiece gp3 = new GreyPiece(1, 1, 0, 3);
		GreyPiece gp4 = new GreyPiece(2, 1, 0, 4);
		GreyPiece gp5 = new GreyPiece(1, 2, 1, 2);
		GreyPiece gp6 = new GreyPiece(1, 1, 3, 0);
		GreyPiece gp7 = new GreyPiece(1, 2, 3, 1);
		GreyPiece gp8 = new GreyPiece(1, 1, 3, 3);
		GreyPiece gp9 = new GreyPiece(2, 1, 2, 4);
